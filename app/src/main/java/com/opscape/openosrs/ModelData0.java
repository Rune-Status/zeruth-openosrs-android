...
@ObfuscatedName("ew")
@Implements("com.opscape.openosrs.ModelData0")
public class ModelData0 {
	...
	static void getLoginError(int var0) {
		if (var0 == -3) {
			...
			AbstractWorldMapData.setLoginResponseString("Unable to connect.", "com.opscape.openosrs.Login server offline.", "");
		} else if (var0 == 9) {
			AbstractWorldMapData.setLoginResponseString("com.opscape.openosrs.Login limit exceeded.", "Too many connections from your address.", "");
		} else if (var0 == 10) {
