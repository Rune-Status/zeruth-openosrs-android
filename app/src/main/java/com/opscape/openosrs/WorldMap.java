...
@ObfuscatedName("ld")
@Implements("com.opscape.openosrs.WorldMap")
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			if (var10 && this.showCoord && this.mouseCoord != null) {
				this.font.draw("com.opscape.openosrs.Coord: " + this.mouseCoord, Rasterizer2D.Rasterizer2D_xClipStart + 10, Rasterizer2D.Rasterizer2D_yClipStart + 20, 16776960, -1);
			}
