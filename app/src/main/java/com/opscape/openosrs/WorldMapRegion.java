...
@ObfuscatedName("as")
@Implements("com.opscape.openosrs.WorldMapRegion")
public class WorldMapRegion {
	...
	public static void method504(String var0, String var1, int var2, int var3) throws IOException {
		...
		File newPath = new File(path, "/" + var4);
		newPath.mkdirs();
		GrandExchangeOfferNameComparator.FileSystem_cacheDir = newPath;
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			if (var0 != 100) {
				...
				BufferedSource.method5925(MusicPatchNode2.archive19, "com.opscape.openosrs.World Map");
				BufferedSource.method5925(AbstractWorldMapData.archive18, "com.opscape.openosrs.World Map Geography");
				BufferedSource.method5925(UserComparator9.archive20, "com.opscape.openosrs.World Map Ground");
