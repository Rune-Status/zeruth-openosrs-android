...
@ObfuscatedName("gm")
@Implements("com.opscape.openosrs.MidiPcmStream")
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4) {
					var0.draw("com.opscape.openosrs.Login: ", Login.loginBoxX + 180 - 110, var28, 16777215, 0);
					var29 = 200;
			...
			if (Client.gameState == 10 || Client.gameState == 11) {
				...
				if (Login.loginIndex == 0) {
					...
					var0.drawLines("New com.opscape.openosrs.User", var4 - 73, var18 - 20, 144, 40, 16777215, 0, 1, 1, 0);
					var4 = Login.loginBoxX + 180 + 80;
					Login.titlebuttonSprite.drawAt(var4 - 73, var18 - 20);
					var0.drawLines("Existing com.opscape.openosrs.User", var4 - 73, var18 - 20, 144, 40, 16777215, 0, 1, 1, 0);
					...
					if (Login.loginIndex == 2) {
						...
						var28 += 15;
						var28 += 7;
						var0.draw("com.opscape.openosrs.Login: ", Script.loginBoxCenter - 110, var28, 16777215, 0);
						var29 = 200;
						...
						var0.drawCentered("com.opscape.openosrs.Login", var16, var17 + 5, 16777215, 0);
						...
						if (Login.loginIndex == 5) {
							...
							var28 += 15;
							var28 += 14;
							var0.draw("com.opscape.openosrs.Username/email: ", Login.loginBoxX + 180 - 145, var28, 16777215, 0);
							var29 = 174;
							if (Interpreter.clientPreferences.hideUsername) {
								var8 = Login.Login_username;
								var7 = UserComparator6.method3370('*', var8.length());
			...
			if (Client.gameState > 5 && Varps.clientLanguage == Language.Language_EN) {
				if (class54.field483 != null) {
					...
					var0.drawCentered("com.opscape.openosrs.World" + " " + Client.worldId, var32 / 2 + var28, var20 / 2 + var29 - 2, 16777215, 0);
