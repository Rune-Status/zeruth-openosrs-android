...
@ObfuscatedName("ec")
@Implements("com.opscape.openosrs.UserComparator8")
						...
						if (var35 == 1 && var59 >= var64 - 75 && var59 <= var64 + 75 && var60 >= var63 - 20 && var60 <= var63 + 20 || var66) {
							if ((Client.worldProperties & 33554432) != 0) {
								...
								if ((Client.worldProperties & 1024) != 0) {
									...
									Login.Login_response2 = "com.opscape.openosrs.Players can attack each other almost everywhere";
									Login.Login_response3 = "and the Protect Item prayer won't work.";
								} else {
									Login.Login_response1 = "This is a <col=ff0000>PvP<col=ffffff> world.";
									Login.Login_response2 = "com.opscape.openosrs.Players can attack each other";
