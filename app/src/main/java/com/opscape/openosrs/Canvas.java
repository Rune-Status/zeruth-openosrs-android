...
@ObfuscatedName("af")
@Implements("com.opscape.openosrs.Canvas")
public final class Canvas extends android.graphics.Canvas {
	@ObfuscatedName("qn")
	@ObfuscatedGetter(
		intValue = 739574061
	)
	...
	Canvas(android.graphics.Canvas var1) {
		this.component = var1;
	}
	...
	public final void paint(Object var1) {
