package com.opscape.openosrs;/* TODO Mouse - Whole Class
...
@ObfuscatedName("bg")
@Implements("com.opscape.openosrs.MouseHandler")
public class MouseHandler {
	...
	@Export("getButton")
	final int getButton(Object var1) {
		return -1;
	}

	public final synchronized void mouseMoved(Object var1) {
	}

	public final synchronized void mousePressed(Object var1) {
	}

	public final void mouseClicked(Object var1) {
	}

	public final synchronized void mouseEntered(Object var1) {
		this.mouseMoved(var1);
	}

	public final synchronized void mouseExited(Object var1) {
	}

	public final synchronized void mouseDragged(Object var1) {
		this.mouseMoved(var1);
	}

	public final synchronized void focusLost(Object var1) {
	...
	public final synchronized void mouseReleased(Object var1) {
