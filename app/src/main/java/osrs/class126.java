		...
		if (var3 > Client.npcCount) {
			...
			for (var14 = 0; var14 < Client.field533; ++var14) {
				...
				if ((var5 & 4) != 0) {
					...
					var8 = var15.x - (var6 - Decimator.baseX * 64 - Decimator.baseX * 64) * 64;
				...
				if ((var5 & 1) != 0) {
					var15.spotAnimation = var1.method7677();
					var6 = var1.method7690();
					var15.field1195 = var6 >> 16;
					var15.field1176 = (var6 & 65535) + Client.cycle;
				...
				if ((var5 & 1024) != 0) {
					var15.field1187 = Client.cycle + var1.method7677();
				...
				if (class309.field3942 && (var5 & 512) != 0 || !class309.field3942 && (var5 & 2) != 0) {
					var15.field1178 = var1.method7672();
					var15.field1127 = var1.method7658();
					var15.field1179 = var1.method7672();
					var15.field1181 = var1.readByte();
					var15.field1182 = var1.method7654() + Client.cycle;
					var15.field1183 = var1.method7654() + Client.cycle;
					var15.field1136 = var1.method7654();
					var15.pathLength = 1;
					var15.field1201 = 0;
				...
				if ((var5 & 2048) != 0) {
					var15.field1202 = var1.method7690();
				}
			}
