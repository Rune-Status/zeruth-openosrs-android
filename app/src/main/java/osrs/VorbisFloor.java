...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field267 = new int[var5];
			this.field267[0] = 0;
			this.field267[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field267[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field272 == null || field272.length < var5) {
				field272 = new int[var5];
				field275 = new int[var5];
				field276 = new boolean[var5];
			}
	...
	@ObfuscatedName("w")
	int method646(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("v")
	void method647(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field272[var1];
			int var5 = field275[var1];
			boolean var6 = field276[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field272[var7];
				if (var8 < var4) {
					field272[var3] = var8;
					field275[var3] = field275[var7];
					field276[var3] = field276[var7];
					++var3;
					field272[var7] = field272[var3];
					field275[var7] = field275[var3];
					field276[var7] = field276[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field267.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field272[var3] = this.field267[var3];
			}

			var3 = field265[this.multiplier - 1];
			int var4 = ViewportMouse.iLog(var3 - 1);
			field275[0] = VorbisSample.readBits(var4);
			field275[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method963();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field275[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method963() : 0;
				}
			}
	...
	@ObfuscatedName("i")
	void method658(float[] var1, int var2) {
		int var3 = this.field267.length;
		int var4 = field265[this.multiplier - 1];
		boolean[] var5 = field276;
		field276[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method650(field272, var6);
			var8 = method645(field272, var6);
			var9 = this.method646(field272[var7], field275[var7], field272[var8], field275[var8], field272[var6]);
			var10 = field275[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field276;
				field276[var8] = true;
				var14[var7] = true;
				field276[var6] = true;
				if (var10 >= var13) {
					field275[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field275[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field276[var6] = false;
				field275[var6] = var9;
		...
		var6 = 0;
		var7 = field275[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field276[var8]) {
				var9 = field272[var8];
				var10 = field275[var8] * this.multiplier;
				this.method647(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("s")
	static int method650(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
	...
	@ObfuscatedName("h")
	static int method645(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
