...
public class MusicPatchPcmStream extends PcmStream {
	...
	void method5314(MusicPatchNode var1, int[] var2, int var3, int var4, int var5) {
		if ((this.superStream.field3223[var1.field3280] & 4) != 0 && var1.field3266 < 0) {
			int var6 = this.superStream.field3214[var1.field3280] / class344.field4152;
			...
			while (true) {
				...
				int var8 = class344.field4152 / 100;
				...
				if (this.superStream.field3221[var1.field3280] == 0) {
					...
					this.superStream.method5135(var1, var1.patch.field3249[var1.field3286] < 0);
	...
	void method5315(MusicPatchNode var1, int var2) {
		if ((this.superStream.field3223[var1.field3280] & 4) != 0 && var1.field3266 < 0) {
			int var3 = this.superStream.field3214[var1.field3280] / class344.field4152;
	...
	protected void fill(int[] var1, int var2, int var3) {
		...
		for (MusicPatchNode var6 = (MusicPatchNode)this.queue.last(); var6 != null; var6 = (MusicPatchNode)this.queue.previous()) {
			if (!this.superStream.method5157(var6)) {
				int var4 = var2;
				int var5 = var3;

				do {
					if (var5 <= var6.field3282) {
						this.method5314(var6, var1, var4, var5, var5 + var4);
						var6.field3282 -= var5;
						break;
					}

					this.method5314(var6, var1, var4, var6.field3282, var5 + var4);
					var4 += var6.field3282;
					var5 -= var6.field3282;
				} while(!this.superStream.method5158(var6, var1, var4, var5));
			}
		}
	...
	protected void skip(int var1) {
		...
		for (MusicPatchNode var3 = (MusicPatchNode)this.queue.last(); var3 != null; var3 = (MusicPatchNode)this.queue.previous()) {
			if (!this.superStream.method5157(var3)) {
				int var2 = var1;

				do {
					if (var2 <= var3.field3282) {
						this.method5315(var3, var2);
						var3.field3282 -= var2;
						break;
					}

					this.method5315(var3, var3.field3282);
					var2 -= var3.field3282;
				} while(!this.superStream.method5158(var3, (int[])null, 0, var2));
			}
		}
