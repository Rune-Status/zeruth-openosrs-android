...
public class Widget extends Node {
	...
	public SpritePixels getSprite(boolean var1, UrlRequester var2) {
		...
		if (this.field3373 != null) {
			SpritePixels var3 = this.method5465(var2);
			if (var3 != null) {
				return var3;
			}
		}
	...
	SpritePixels method5465(UrlRequester var1) {
		if (!this.method5467()) {
			return this.method5466(var1);
		} else {
			String var2 = this.field3373 + (this.spriteFlipV ? 1 : 0) + (this.spriteFlipH ? 1 : 0) + this.outline + this.spriteShadow;
			SpritePixels var3 = (SpritePixels)field3354.method6420(var2);
			if (var3 == null) {
				SpritePixels var4 = this.method5466(var1);
				if (var4 != null) {
					var3 = var4.method7999();
					this.method5478(var3);
					field3354.method6421(var2, var3);
				}
			}
	...
	SpritePixels method5466(UrlRequester var1) {
		if (this.field3373 != null && var1 != null) {
			class291 var2 = (class291)field3353.method6420(this.field3373);
			if (var2 == null) {
				var2 = new class291(this.field3373, var1);
				field3353.method6421(this.field3373, var2);
			}

			return var2.method5420();
		} else {
			return null;
		}
	}
	...
	void method5478(SpritePixels var1) {
		if (this.spriteFlipV) {
			var1.flipVertically();
		}
	...
	public void method5468(String var1, UrlRequester var2, long var3) {
		if (this.type == 11 && -1L != var3) {
			var1 = var1.replaceAll("%userid%", Long.toString(var3));
			this.field3431 = new class155();
			if (!this.field3431.method3098(var1, var2)) {
				this.field3431 = null;
			} else {
	...
	public void method5462(String var1, int var2) {
		if (this.type == 11) {
	...
	public boolean method5479(int var1, int var2, int var3, int var4) {
		if (this.type == 11 && this.field3431 != null && this.method5491()) {
			var1 -= var3;
			var2 -= var4;
			int var5 = (int)(this.field3431.method3049()[0] * (float)this.width);
			int var6 = (int)(this.field3431.method3049()[1] * (float)this.height);
			int var7 = var5 + (int)(this.field3431.method3049()[2] * (float)this.width);
			int var8 = var6 + (int)(this.field3431.method3049()[3] * (float)this.height);
	...
	public int method5481(String var1) {
		return this.type == 11 && this.field3431 != null && this.method5491() ? this.field3431.method3044(var1) : -1;
	}
	...
	public String method5482(String var1) {
		return this.type == 11 && this.field3431 != null && this.method5491() ? this.field3431.method3045(var1) : null;
	}
	...
	public int method5484() {
		if (this.type == 11 && this.field3431 != null && this.field3438 != null && !this.field3438.isEmpty()) {
			String var1 = this.field3431.method3048();
			return var1 != null && this.field3438.containsKey(this.field3431.method3048()) ? (Integer)this.field3438.get(var1) : -1;
		} else {
			return -1;
		}
	}
	...
	public String method5485() {
		if (this.type == 11 && this.field3431 != null) {
			String var1 = this.field3431.method3048();
			Iterator var2 = this.field3431.method3050().iterator();

			while (var2.hasNext()) {
				class165 var3 = (class165)var2.next();
				String var4 = String.format("%%%S%%", var3.method3173());
				if (var3.vmethod3172() == 0) {
					var1.replaceAll(var4, Integer.toString(var3.vmethod3174()));
				} else {
					var1.replaceAll(var4, var3.vmethod3185());
				}
			}
	...
	public int[] method5524() {
		if (this.type == 11 && this.field3431 != null) {
			int[] var1 = new int[3];
			int var2 = 0;
			Iterator var3 = this.field3431.method3050().iterator();

			while (var3.hasNext()) {
				class165 var4 = (class165)var3.next();
				if (!var4.method3173().equals("user_id")) {
					if (var4.vmethod3172() != 0) {
						return null;
					}

					var1[var2++] = var4.vmethod3174();
					if (var2 > 3) {
						return null;
					}
				}
	...
	public boolean method5539(UrlRequester var1) {
		if (this.type == 11 && this.field3431 != null) {
			this.field3431.method3073(var1);
			if (this.field3431.method3043() != this.field3432) {
				this.field3432 = this.field3431.method3043();
	...
	void method5488() {
		...
		ArrayList var1 = this.field3431.method3077();
		ArrayList var2 = this.field3431.method3047();
		...
		for (var5 = var1.iterator(); var5.hasNext(); this.children[var4++] = var7) {
			...
			var7 = InvDefinition.method3213(5, this, var4, 0, 0, 0, 0, var6.field1748);
			var7.field3373 = var6.field1749.method2463();
			class291 var8 = new class291(var6.field1749);
			field3353.method6421(var7.field3373, var8);
		}

		for (var5 = var2.iterator(); var5.hasNext(); this.children[var4++] = var7) {
			class161 var9 = (class161)var5.next();
			var7 = InvDefinition.method3213(4, this, var4, 0, 0, 0, 0, var9.field1752);
