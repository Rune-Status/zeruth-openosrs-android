...
public class ArchiveLoader {
	...
	boolean isLoaded() {
		...
		for (int var1 = 0; var1 < this.groupCount; ++var1) {
			if (!this.archive.method5651(var1) || this.archive.method5648(var1)) {
				++this.loadedCount;
			}
		}
	...
	static final void worldToMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		...
		if (var6 > 4225 && var6 < 90000) {
			...
			byte var17 = 20;
			MouseRecorder.redHintArrowSprite.method7985(var15 + (var0 + var5.width / 2 - var17 / 2), var5.height / 2 + var1 - var17 / 2 - var16 - 10, var17, var17, 15, 15, var12, 256);
		} else {
