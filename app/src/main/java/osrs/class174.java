	...
	static void loginScreen(GameEngine var0, Font var1) {
		...
		if (Login.worldSelectOpen) {
			...
			if ((MouseHandler.MouseHandler_lastButton == 1 || !Bounds.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50 && MouseHandler.MouseHandler_lastPressedY >= 453) {
				ClanMate.clientPreferences.method2147(!ClanMate.clientPreferences.method2148());
				if (!ClanMate.clientPreferences.method2148()) {
					Renderable.method4164(PacketBuffer.archive6, "scape main", "", 255, false);
				} else {
					VarcInt.method3263();
				}
			}
			...
			if (Client.gameState != 5) {
				if (-1L == Login.field889) {
					Login.field889 = class181.method3418() + 1000L;
				}

				long var22 = class181.method3418();
				boolean var4;
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					if (Login.loginIndex == 0) {
						...
						if (var5 == 1 && var54 >= var44 - 75 && var54 <= var44 + 75 && var41 >= var45 - 20 && var41 <= var45 + 20) {
							class400.openURL(ModeWhere.method5931("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}
						...
						if (Login.loginIndex == 1) {
							...
							if (Login.loginIndex == 2) {
								...
								if (var5 == 1 && Login.field868) {
									...
									if (!Client.Login_isUsernameRemembered && ClanMate.clientPreferences.method2162() != null) {
								...
								if (var5 == 1 && Login.field894) {
									ClanMate.clientPreferences.method2145(!ClanMate.clientPreferences.method2146());
									if (!ClanMate.clientPreferences.method2146()) {
										Login.Login_username = "";
										ClanMate.clientPreferences.method2203((String)null);
										ReflectionCheck.method580();
									}
...
/*									Transferable var56;*/
												...
												while (true) {
													while (ParamComposition.isKeyDown()) {
														if (class145.field1653 != 13) {
															...
															if (WorldMapSectionType.method4812(BoundaryObject.field2636) && Login.Login_username.length() < 320) {
	...
	/*											Clipboard var55 = Toolkit.getDefaultToolkit().getSystemClipboard();
											...
											if (var46 && WorldMapSectionType.method4812(BoundaryObject.field2636) && Login.Login_password.length() < 20) {
...
/*									try {
										...
										for (int var51 = 0; var51 < var50; ++var51) {
											...
											if (!var17 || !WorldMapSectionType.method4812(var14.charAt(var51))) {
												class116.method2618(3);
												return;
											}
										}
								...
								if (Login.loginIndex == 4) {
									...
									if (var5 == 1 && var54 >= Login.loginBoxX + 180 - 34 && var54 <= Login.loginBoxX + 34 + 180 && var41 >= 351 && var41 <= 363) {
										class400.openURL(ModeWhere.method5931("secure", true) + "m=totp-authenticator/disableTOTPRequest", true, false);
									}
									...
									if (UrlRequester.field1346 != null) {
										...
										if (var5 == 1 && var54 >= UrlRequester.field1346.lowX - var11 && var54 <= var11 + UrlRequester.field1346.lowX && var41 >= var45 - 15 && var41 < var45) {
											class400.openURL(ModeWhere.method5931("secure", true) + "m=weblogin/g=oldscape/cant_log_in", true, false);
										}
									}
									...
									if (Login.loginIndex == 7) {
										if (class82.field1066 && !Client.onMobile) {
											...
											if (var5 == 1 && var54 >= var42 && var54 <= var44 && var41 >= var45 && var41 <= var11) {
												Login.field891 = WorldMapSection0.method4802(var42, var54);
											}
											...
											if (var5 == 1 && var54 >= var12 - 75 && var54 <= var12 + 75 && var41 >= var13 - 20 && var41 <= var13 + 20) {
												label1355: {
													...
													if (var30 == null) {
														...
														var18 = class134.method2793(var30);
														if (!var18) {
															class116.method2618(7);
															ItemComposition.setLoginResponseString("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900");
															var29 = false;
											...
											var9 = 321;
											if (var5 == 1 && var54 >= var42 - 75 && var54 <= var42 + 75 && var41 >= var9 - 20 && var41 <= var9 + 20) {
												class400.openURL(ModeWhere.method5931("secure", true) + "m=dob/set_dob.ws", true, false);
										...
										var9 = 233;
										Bounds var34 = var1.method6282(0, 30, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var42, var9);
										Bounds var26 = var1.method6282(32, 32, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var42, var9);
										Bounds var27 = var1.method6282(70, 34, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var42, var9);
										var44 = var9 + 17;
										Bounds var28 = var1.method6282(0, 34, "<col=ffd200>agreement (EULA)</col>.", var42, var44);
										if (var5 == 1) {
											if (var34.method6766(var54, var41)) {
												class400.openURL("https://www.jagex.com/terms", true, false);
											} else if (var26.method6766(var54, var41)) {
												class400.openURL("https://www.jagex.com/terms/privacy", true, false);
											} else if (var27.method6766(var54, var41) || var28.method6766(var54, var41)) {
	...
	static final void method3317(boolean var0) {
		if (var0) {
