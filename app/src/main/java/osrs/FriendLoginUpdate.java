...
public class FriendLoginUpdate extends Link {
	...
	FriendLoginUpdate(Username var1, int var2) {
		this.field4296 = (int)(class181.method3418() / 1000L);
		this.username = var1;
	...
	static boolean method6515(String var0, int var1, String var2) {
		if (var1 == 0) {
			try {
...
/*				class29.field174.getAppletContext().showDocument(new URL(class29.field174.getCodeBase(), var0), "_top");*/
	...
	static final void method6514(PacketBuffer var0, int var1, Player var2, int var3) {
		byte var4 = class192.field2205.field2208;
		if ((var3 & 256) != 0) {
			var2.field1178 = var0.method7551();
			var2.field1127 = var0.method7565();
			var2.field1179 = var0.readByte();
			var2.field1181 = var0.method7564();
			var2.field1182 = var0.method7533() + Client.cycle;
			var2.field1183 = var0.method7547() + Client.cycle;
			var2.field1136 = var0.method7570();
			if (var2.field1111) {
		...
		int var12;
		if ((var3 & 16) != 0) {
			var5 = var0.method7547();
			PlayerType var6 = (PlayerType)GameEngine.findEnumerated(class220.PlayerType_values(), var0.method7601());
			boolean var7 = var0.method7679() == 1;
			var8 = var0.method7679();
			var9 = var0.offset;
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var10 && Client.field601 == 0 && !var2.isHidden) {
					...
					var0.method7585(Players.field1309.array, 0, var8);
					Players.field1309.offset = 0;
					String var11 = AbstractFont.escapeBrackets(AbstractWorldMapData.method4828(class229.method4746(Players.field1309)));
		...
		if ((var3 & 64) != 0) {
			var2.targetIndex = var0.method7570();
		...
		if ((var3 & 2048) != 0) {
			...
			var13[var1] = (class192)GameEngine.findEnumerated(var15, var0.method7565());
		}

		int var14;
		if ((var3 & 2) != 0) {
			var5 = var0.method7570();
			if (var5 == 65535) {
				var5 = -1;
			}

			var14 = var0.method7679();
			Strings.performPlayerAnimation(var2, var5, var14);
		}

		if ((var3 & 8192) != 0) {
			var2.field1187 = Client.cycle + var0.method7533();
			var2.field1188 = Client.cycle + var0.method7547();
			var2.field1189 = var0.method7565();
			var2.field1131 = var0.method7565();
			var2.field1191 = var0.method7551();
			var2.field1192 = (byte)var0.method7563();
		}
		...
		if ((var3 & 16384) != 0) {
			var4 = var0.method7551();
		}

		if ((var3 & 4) != 0) {
			var5 = var0.method7601();
		...
		if ((var3 & 1024) != 0) {
			var2.spotAnimation = var0.method7570();
			var5 = var0.method7583();
		...
		if ((var3 & 8) != 0) {
			var2.field1162 = var0.method7570();
			...
			if (var14 > 0) {
				for (var19 = 0; var19 < var14; ++var19) {
					...
					if (var9 != 32767) {
						...
						var12 = var9 > 0 ? var0.method7679() : var16;
		...
		if (var2.field1111) {
			if (var4 == 127) {
				...
				var2.method2066(var2.tileX, var2.tileY, var21);
			}
		}
