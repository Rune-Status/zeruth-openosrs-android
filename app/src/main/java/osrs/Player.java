...
public final class Player extends Actor {
	...
	final void read(Buffer var1) {
		...
		if (var8 > 0 && var8 != 32768) {
			...
			for (var9 = 0; var9 < 12; ++var9) {
				...
				if (var10 == 1) {
					var12[var9] = UserComparator8.method2486(var4[var9] - 512, var1);
				}
			}
		}
		...
		this.appearance.method5423(var4, var12, var13, var11, var2 == 1, var3);
	}
			...
			if (var3 == null) {
				...
				if (!this.isUnanimated && this.model0 != null) {
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
						var5 = this.model0;
						var5.offsetBy(this.field1093 - super.x, this.tileHeight2 - this.tileHeight, this.field1097 - super.y);
						...
						var5.offsetBy(super.x - this.field1093, this.tileHeight - this.tileHeight2, super.y - this.field1097);
					}
				}
	...
	void updateIsInClanChat() {
		for (int var1 = 0; var1 < 4; ++var1) {
			if (Client.currentClanSettings[var1] != null && Client.currentClanSettings[var1].method2836(this.username.getName()) != -1 && var1 != 2) {
	...
	final void method2066(int var1, int var2, class192 var3) {
						...
						while (true) {
							...
							if (var15 >= 128) {
								...
								while (true) {
									...
									var4.method2041(Client.field547[var16], Client.field771[var16], var5);
									++var16;
								}
							}
	...
	final void method2041(int var1, int var2, class192 var3) {
	...
	static void method2082(int var0, int var1, int var2, ObjectComposition var3, int var4) {
