...
public enum class6 implements MouseWheel {
	...
	static void method42(int var0, int var1, int var2, int var3) {
		for (ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
			if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
				...
				if (var5 - 64 <= var4.field812 && ClanMate.clientPreferences.method2161() != 0 && var0 == var4.plane) {
					var5 -= 64;
					if (var5 < 0) {
						var5 = 0;
					}

					int var6 = (var4.field812 - var5) * ClanMate.clientPreferences.method2161() / var4.field812;
	...
	static void Login_promptCredentials(boolean var0) {
		if (!AbstractByteArrayCopier.client.method1085() && !AbstractByteArrayCopier.client.method1086()) {
			Login.Login_response1 = "";
			Login.Login_response2 = "Enter your username/email & password.";
			Login.Login_response3 = "";
			class116.method2618(2);
			if (var0) {
