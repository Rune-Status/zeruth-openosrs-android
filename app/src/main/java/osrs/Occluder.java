...
public final class Occluder {
	...
	public static double[] method4170(double var0, double var2, int var4) {
		int var5 = var4 * 2 + 1;
	...
	public static int method4171(int var0) {
		return FileSystem.method3149(ViewportMouse.ViewportMouse_entityTags[var0]);
	}
