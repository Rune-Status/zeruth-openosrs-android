...
public enum AttackOption implements MouseWheel {
	...
	static int method2295(Widget var0) {
		if (var0.type != 11) {
			...
			Interpreter.Interpreter_stringStack[++UserComparator8.Interpreter_stringStackSize - 1] = var0.method5482(var1);
			return 1;
		}
	}
}
