...
public class class119 implements MouseWheel {
	...
	static {
		field1488 = new class119(0, 0, (String)null, -1, -1);
		field1490 = new class119(1, 1, (String)null, 0, 2);
		field1468 = new class119(2, 2, (String)null, 1, 2);
		field1471 = new class119(3, 3, (String)null, 2, 2);
		field1472 = new class119(4, 4, (String)null, 3, 1);
		field1473 = new class119(5, 5, (String)null, 4, 1);
		field1474 = new class119(6, 6, (String)null, 5, 1);
		field1475 = new class119(7, 7, (String)null, 6, 3);
		field1476 = new class119(8, 8, (String)null, 7, 3);
		field1477 = new class119(9, 9, (String)null, 8, 3);
		field1478 = new class119(10, 10, (String)null, 0, 7);
		field1482 = new class119(11, 11, (String)null, 1, 7);
		field1479 = new class119(12, 12, (String)null, 2, 7);
		field1481 = new class119(13, 13, (String)null, 3, 7);
		field1470 = new class119(14, 14, (String)null, 4, 7);
		field1483 = new class119(15, 15, (String)null, 5, 7);
		field1480 = new class119(16, 16, (String)null, 0, 5);
	}
	...
	public static class3 method2667(class6 var0) {
		switch(var0.field20) {
		case 0:
			return new class0();
		default:
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		...
		if (0L != var5) {
			...
			if (var20.mapSceneId != -1) {
				...
				int[] var24 = class1.sceneMinimapSprite.pixels;
		...
		if (var5 != 0L) {
			...
			ObjectComposition var21 = FileSystem.getObjectDefinition(var7);
			if (var21.mapSceneId != -1) {
				IndexedSprite var22 = class120.mapSceneSprites[var21.mapSceneId];
				if (var22 != null) {
