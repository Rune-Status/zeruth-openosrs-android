...
public class SequenceDefinition extends DualNode {
	...
	public Model transformActorModel(Model var1, int var2) {
		...
		if (!this.isCachedModelIdSet()) {
			...
			class122 var3 = StructComposition.method3478(this.SequenceDefinition_cachedModelId);
			if (var3 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
				var4 = var1.toSharedSequenceModel(!var3.method2678());
				var4.method4240(var3, var2);
				return var4;
			}
		}
	}
	...
	Model transformObjectModel(Model var1, int var2, int var3) {
		...
		if (!this.isCachedModelIdSet()) {
			...
			class122 var4 = StructComposition.method3478(this.SequenceDefinition_cachedModelId);
			if (var4 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
				var5 = var1.toSharedSequenceModel(!var4.method2678());
				var3 &= 3;
				if (var3 == 1) {
					var5.rotateY270Ccw();
				} else if (var3 == 2) {
	...
	Model transformSpotAnimationModel(Model var1, int var2) {
		...
		if (!this.isCachedModelIdSet()) {
			...
			if (var3 == null) {
				...
				var4 = var1.toSharedSpotAnimationModel(!var3.method2678());
				var4.method4240(var3, var2);
				return var4;
			}
		}
	...
	public Model applyTransformations(Model var1, int var2, SequenceDefinition var3, int var4) {
		if (field2169 && !this.isCachedModelIdSet() && !var3.isCachedModelIdSet()) {
			return this.method3658(var1, var2, var3, var4);
		} else {
			...
			class122 var9;
			if (this.isCachedModelIdSet()) {
				var9 = this.method3661();
				if (var9 == null) {
					return var5;
				}

				if (var3.isCachedModelIdSet() && this.field2172 == null) {
					var5.method4240(var9, var2);
					return var5;
				}

				var8 = var9.field1498;
				var5.method4220(var8, var9, var2, this.field2172, false, !var3.isCachedModelIdSet());
			} else {
				var2 = this.frameIds[var2];
				...
				if (!var6) {
					var5.method4221(var7, var2, this.field2171, false);
				}
			}

			if (var3.isCachedModelIdSet()) {
				var9 = var3.method3661();
				if (var9 == null) {
					return var5;
				}
				...
				var5.method4220(var8, var9, var4, this.field2172, true, true);
			} else {
				...
				var5.method4221(var10, var4, this.field2171, true);
			}
	...
	Model method3658(Model var1, int var2, SequenceDefinition var3, int var4) {
		var2 = this.frameIds[var2];
		Frames var5 = class142.getFrames(var2 >> 16);
		var2 &= 65535;
		if (var5 == null) {
	...
	class122 method3661() {
		return this.isCachedModelIdSet() ? StructComposition.method3478(this.SequenceDefinition_cachedModelId) : null;
	}
