...
public class ClientPacket implements class261 {
	...
	static final ClientPacket field2920;
	@ObfuscatedName("i")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	static final ClientPacket field2942;
	@ObfuscatedName("av")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	static final ClientPacket field2978;
	@ObfuscatedName("br")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	static final ClientPacket field2986;
	@ObfuscatedName("bo")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	static final ClientPacket field3014;
	@ObfuscatedName("cu")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	public static final ClientPacket field3021;
	@ObfuscatedName("dy")
	@ObfuscatedSignature(
		descriptor = "Ljb;"
	)
	...
	static {
		field2995 = new ClientPacket(0, 7);
		field2916 = new ClientPacket(1, 8);
		field2953 = new ClientPacket(2, 3);
		field2997 = new ClientPacket(3, -2);
		field2919 = new ClientPacket(4, 22);
		field2920 = new ClientPacket(5, 7);
		field2921 = new ClientPacket(6, 0);
		field2970 = new ClientPacket(7, 3);
		field2972 = new ClientPacket(8, -1);
		field2989 = new ClientPacket(9, -1);
		field2999 = new ClientPacket(10, 3);
		field2993 = new ClientPacket(11, 8);
		field2927 = new ClientPacket(12, -1);
		field2928 = new ClientPacket(13, 8);
		field2929 = new ClientPacket(14, 0);
		field2930 = new ClientPacket(15, 4);
		field2931 = new ClientPacket(16, 3);
		field2932 = new ClientPacket(17, 13);
		field2933 = new ClientPacket(18, 8);
		field2924 = new ClientPacket(19, -1);
		field2935 = new ClientPacket(20, 8);
		field2923 = new ClientPacket(21, 11);
		field2940 = new ClientPacket(22, 8);
		field2994 = new ClientPacket(23, 1);
		field2939 = new ClientPacket(24, -1);
		field2936 = new ClientPacket(25, 15);
		field2941 = new ClientPacket(26, 7);
		field2942 = new ClientPacket(27, -1);
		field2943 = new ClientPacket(28, 7);
		field2938 = new ClientPacket(29, 8);
		field2968 = new ClientPacket(30, 8);
		field2946 = new ClientPacket(31, -1);
		field3023 = new ClientPacket(32, 8);
		field2948 = new ClientPacket(33, 0);
		field2949 = new ClientPacket(34, 2);
		field3001 = new ClientPacket(35, 8);
		field2988 = new ClientPacket(36, 3);
		field2952 = new ClientPacket(37, 3);
		field2934 = new ClientPacket(38, 3);
		field2954 = new ClientPacket(39, 7);
		field2955 = new ClientPacket(40, 7);
		field2956 = new ClientPacket(41, 14);
		field2965 = new ClientPacket(42, 7);
		field2958 = new ClientPacket(43, 15);
		field2959 = new ClientPacket(44, 3);
		field2960 = new ClientPacket(45, -1);
		field3024 = new ClientPacket(46, -1);
		field2962 = new ClientPacket(47, -1);
		field2963 = new ClientPacket(48, 8);
		field2964 = new ClientPacket(49, 11);
		field3000 = new ClientPacket(50, 3);
		field2918 = new ClientPacket(51, 8);
		field2967 = new ClientPacket(52, 6);
		field2957 = new ClientPacket(53, 3);
		field2969 = new ClientPacket(54, 8);
		field3015 = new ClientPacket(55, -1);
		field2971 = new ClientPacket(56, 16);
		field3003 = new ClientPacket(57, 8);
		field2973 = new ClientPacket(58, 8);
		field3016 = new ClientPacket(59, 16);
		field2961 = new ClientPacket(60, 3);
		field2976 = new ClientPacket(61, 11);
		field2977 = new ClientPacket(62, 8);
		field2978 = new ClientPacket(63, -1);
		field2979 = new ClientPacket(64, 15);
		field2980 = new ClientPacket(65, 4);
		field2981 = new ClientPacket(66, 3);
		field2947 = new ClientPacket(67, -1);
		field2983 = new ClientPacket(68, 4);
		field2984 = new ClientPacket(69, -1);
		field2985 = new ClientPacket(70, -1);
		field2986 = new ClientPacket(71, -1);
		field2925 = new ClientPacket(72, -1);
		field2950 = new ClientPacket(73, 2);
		field2922 = new ClientPacket(74, 7);
		field2990 = new ClientPacket(75, 5);
		field2991 = new ClientPacket(76, 10);
		field2992 = new ClientPacket(77, 3);
		field2974 = new ClientPacket(78, -1);
		field2937 = new ClientPacket(79, 2);
		field2945 = new ClientPacket(80, 8);
		field2951 = new ClientPacket(81, 6);
		field2944 = new ClientPacket(82, 4);
		field2998 = new ClientPacket(83, 7);
		field3006 = new ClientPacket(84, 7);
		field2915 = new ClientPacket(85, 8);
		field2987 = new ClientPacket(86, -1);
		field3002 = new ClientPacket(87, 9);
		field2917 = new ClientPacket(88, -1);
		field3004 = new ClientPacket(89, 8);
		field3005 = new ClientPacket(90, -2);
		field2966 = new ClientPacket(91, 0);
		field3007 = new ClientPacket(92, -2);
		field3013 = new ClientPacket(93, 7);
		field3009 = new ClientPacket(94, -1);
		field3010 = new ClientPacket(95, 6);
		field3011 = new ClientPacket(96, 16);
		field3012 = new ClientPacket(97, 4);
		field2975 = new ClientPacket(98, 0);
		field3014 = new ClientPacket(99, 2);
		field2982 = new ClientPacket(100, 3);
		field2996 = new ClientPacket(101, 8);
		field3017 = new ClientPacket(102, -1);
		field3018 = new ClientPacket(103, 15);
		field3019 = new ClientPacket(104, 11);
		field3020 = new ClientPacket(105, -1);
		field3021 = new ClientPacket(106, 2);
		field3022 = new ClientPacket(107, 9);
	}
