...
public class ClanSettings {
	...
	public int method2836(String var1) {
	...
	void method2890(long var1, String var3, int var4) {
		...
		if (var1 > 0L != this.useHashes) {
			...
			if (var1 > 0L && (this.memberHashes == null || this.memberCount >= this.memberHashes.length) || var3 != null && (this.memberNames == null || this.memberCount >= this.memberNames.length)) {
				this.method2834(this.memberCount + 5);
			}
	...
	void method2843(long var1, String var3) {
		if (var3 != null && var3.length() == 0) {
			var3 = null;
		}
		...
		if (var1 > 0L != this.useHashes) {
			...
			if (var1 > 0L && (this.bannedMemberHashes == null || this.bannedMemberCount >= this.bannedMemberHashes.length) || var3 != null && (this.bannedMemberNames == null || this.bannedMemberCount >= this.bannedMemberNames.length)) {
				this.method2835(this.bannedMemberCount + 5);
			}
	...
	int method2845(int var1, byte var2) {
	...
	int method2848(int var1, boolean var2) {
	...
	int method2872(int var1, int var2, int var3, int var4) {
		int var5 = (1 << var3) - 1;
	...
	boolean method2849(int var1, int var2) {
		if (this.parameters != null) {
	...
	boolean method2895(int var1, int var2, int var3, int var4) {
		int var5 = (1 << var3) - 1;
		int var6 = var4 == 31 ? -1 : (1 << var4 + 1) - 1;
		int var7 = var6 ^ var5;
		var2 <<= var3;
	...
	@ObfuscatedName("y")
	boolean method2851(int var1, long var2) {
		if (this.parameters != null) {
	...
	boolean method2901(int var1, String var2) {
		if (var2 == null) {
			var2 = "";
	...
	void method2853(Buffer var1) {
		...
		if (var2 >= 1 && var2 <= 6) {
			...
			if (var2 >= 3) {
				...
				if (var4 > 0) {
					this.parameters = new IterableNodeHashTable(var4 < 16 ? WorldMapDecoration.method4847(var4) : 16);
	...
	public static int method2844(int var0) {
