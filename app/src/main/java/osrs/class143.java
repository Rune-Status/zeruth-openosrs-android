...
public class class143 extends class128 {
	...
	void vmethod3019(ClanSettings var1) {
		var1.method2890(this.field1642, this.field1640, this.field1641);
	}
	...
	static void method2938(Float var0, Float var1) {
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < Client.mapIconCount; ++var8) {
					var9 = Client.mapIconXs[var8] * 4 + 2 - ScriptFrame.localPlayer.x / 32;
					var10 = Client.mapIconYs[var8] * 4 + 2 - ScriptFrame.localPlayer.y / 32;
					SecureRandomCallable.drawSpriteOnMinimap(var1, var2, var9, var10, Client.mapIcons[var8], var4);
				}
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var9 = 0; var9 < 104; ++var9) {
						NodeDeque var14 = Client.groundItems[class268.Client_plane][var8][var9];
						if (var14 != null) {
							var11 = var8 * 4 + 2 - ScriptFrame.localPlayer.x / 32;
							var12 = var9 * 4 + 2 - ScriptFrame.localPlayer.y / 32;
				...
				for (var8 = 0; var8 < Client.npcCount; ++var8) {
					...
					if (var15 != null && var15.isVisible()) {
						...
						if (var17 != null && var17.drawMapDot && var17.isInteractable) {
							var11 = var15.x / 32 - ScriptFrame.localPlayer.x / 32;
							var12 = var15.y / 32 - ScriptFrame.localPlayer.y / 32;
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var16 != null && var16.isVisible() && !var16.isHidden && var16 != ScriptFrame.localPlayer) {
						var12 = var16.x / 32 - ScriptFrame.localPlayer.x / 32;
						int var13 = var16.y / 32 - ScriptFrame.localPlayer.y / 32;
						if (var16.isFriend()) {
							SecureRandomCallable.drawSpriteOnMinimap(var1, var2, var12, var13, MusicPatchNode.mapDotSprites[3], var4);
						} else if (ScriptFrame.localPlayer.team != 0 && var16.team != 0 && var16.team == ScriptFrame.localPlayer.team) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - Decimator.baseX * 4 + 2 - ScriptFrame.localPlayer.x / 32;
						var11 = Client.hintArrowY * 4 - class7.baseY * -2126502212 + 2 - ScriptFrame.localPlayer.y / 32;
