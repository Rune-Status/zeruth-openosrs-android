...
public class class67 {
	...
	public static class263[] method1796() {
	...
	static int method1797(int var0, Script var1, boolean var2) {
		if (var0 == 3600) {
			...
			if (var0 == 3601) {
				...
				if (class321.friendSystem.method1562() && var3 >= 0 && var3 < class321.friendSystem.friendsList.getSize()) {
				...
				if (var0 == 3604) {
					...
					JagexCache.method3140(var5, var6);
					return 1;
				} else if (var0 == 3605) {
					var5 = Interpreter.Interpreter_stringStack[--UserComparator8.Interpreter_stringStackSize];
					...
					var5 = Interpreter.Interpreter_stringStack[--UserComparator8.Interpreter_stringStackSize];
					var5 = WorldMapSection0.method4803(var5);
					...
					var5 = Interpreter.Interpreter_stringStack[--UserComparator8.Interpreter_stringStackSize];
					Login.method1850(var5);
					return 1;
				} else if (var0 == 3620) {
					class114.method2573();
					return 1;
				} else if (var0 == 3621) {
					if (!class321.friendSystem.method1562()) {
						Interpreter.Interpreter_intStack[++User.Interpreter_intStackSize - 1] = -1;
					} else {
					...
					var3 = Interpreter.Interpreter_intStack[--User.Interpreter_intStackSize];
					if (class321.friendSystem.method1562() && var3 >= 0 && var3 < class321.friendSystem.ignoreList.getSize()) {
