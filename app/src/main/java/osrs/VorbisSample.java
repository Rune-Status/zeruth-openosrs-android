...
public class VorbisSample extends Node {
	...
	float[] method970(int var1) {
		...
		readBit();
		int var2 = readBits(ViewportMouse.iLog(VorbisSample_mapping.length - 1));
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) {
			...
			float[] var19 = field384;
			var18.method760(var19, var4 >> 1, var45);
		}
		...
		if (!var15) {
			...
			VorbisSample_floors[var40].method658(field384, var4 >> 1);
		}
		...
		if (var15) {
			...
			float[] var44 = var3 ? field388 : field385;
		...
		float[] var42 = null;
		if (this.field390 > 0) {
			var40 = var4 + this.field390 >> 2;
			var42 = new float[var40];
			int var43;
			if (!this.field394) {
				for (var41 = 0; var41 < this.field382; ++var41) {
					var43 = var41 + (this.field390 >> 1);
					var42[var41] += this.field380[var43];
				}
			}
			...
			if (!var15) {
				for (var41 = var8; var41 < var4 >> 1; ++var41) {
					...
					var42[var43] += field384[var41];
				}
			}
		}

		float[] var46 = this.field380;
