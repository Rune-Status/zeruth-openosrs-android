...
public class FileSystem {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			byte var35 = 0;
			var0 = var35 + ClanChannelMember.archive5.percentage() * 4 / 100;
			var0 += Decimator.field403.percentage() * 4 / 100;
			var0 += Renderable.archive2.percentage() * 2 / 100;
			var0 += class306.archive7.percentage() * 2 / 100;
			var0 += class271.archive4.percentage() * 6 / 100;
			var0 += class120.archive9.percentage() * 4 / 100;
			var0 += PacketBuffer.archive6.percentage() * 2 / 100;
			var0 += FloorUnderlayDefinition.archive11.percentage() * 55 / 100;
			var0 += class299.archive8.percentage() * 2 / 100;
			var0 += class201.field2366.percentage() * 2 / 100;
			var0 += KitDefinition.archive10.percentage() * 2 / 100;
			var0 += class17.field89.percentage() * 2 / 100;
			var0 += SequenceDefinition.archive12.percentage() * 2 / 100;
			var0 += MouseRecorder.archive13.percentage() * 2 / 100;
			var0 += Varcs.archive14.percentage() * 2 / 100;
			var0 += class268.archive15.percentage() * 2 / 100;
			var0 += Tile.archive19.percentage() / 100;
			var0 += class340.archive18.percentage() / 100;
			var0 += Friend.archive20.percentage() / 100;
			var0 += Timer.field4232.percentage() / 100;
			var0 += MouseHandler.archive17.method5639() && MouseHandler.archive17.isFullyLoaded() ? 1 : 0;
			if (var0 != 100) {
				if (var0 != 0) {
			...
			class344.field4152 = 22050;
			PcmPlayer.PcmPlayer_stereo = var34;
			PcmPlayer.field279 = 2;
			MidiPcmStream var29 = new MidiPcmStream();
			var29.method5131(9, 128);
			class78.pcmPlayer0 = class162.method3162(GameEngine.taskHandler, 0, 22050);
			class78.pcmPlayer0.setStream(var29);
			UrlRequest.method2455(class268.archive15, Varcs.archive14, class271.archive4, var29);
			MouseRecorder.pcmPlayer1 = class162.method3162(GameEngine.taskHandler, 1, 2048);
			ModeWhere.pcmStreamMixer = new PcmStreamMixer();
			MouseRecorder.pcmPlayer1.setStream(ModeWhere.pcmStreamMixer);
			ScriptEvent.decimator = new Decimator(22050, class344.field4152);
			...
			if (Client.titleLoadingStage == 50) {
				FontName[] var37 = new FontName[]{FontName.FontName_bold12, FontName.FontName_verdana15, FontName.FontName_verdana11, FontName.FontName_verdana13, FontName.FontName_plain12, FontName.FontName_plain11};
				var24 = var37.length;
				Fonts var30 = class129.WorldMapElement_fonts;
				FontName[] var31 = new FontName[]{FontName.FontName_bold12, FontName.FontName_verdana15, FontName.FontName_verdana11, FontName.FontName_verdana13, FontName.FontName_plain12, FontName.FontName_plain11};
				Client.fontsMap = var30.createMap(var31);
				...
				if (Client.titleLoadingStage == 60) {
					var1 = KitDefinition.archive10;
					Archive var2 = class299.archive8;
					var25 = 0;
					String[] var32 = Login.field901;

					int var5;
					String var33;
					for (var5 = 0; var5 < var32.length; ++var5) {
						var33 = var32[var5];
						if (var1.tryLoadFileByNames(var33, "")) {
							++var25;
						}
					}

					var32 = Login.field906;

					for (var5 = 0; var5 < var32.length; ++var5) {
						var33 = var32[var5];
						if (var2.tryLoadFileByNames(var33, "")) {
							++var25;
						}
					}

					var28 = Login.field901.length + Login.field906.length;
					if (var25 < var28) {
						Login.Login_loadingText = "Loading title screen - " + var25 * 100 / var28 + "%";
					...
					if (Client.titleLoadingStage == 80) {
						...
						if (class120.mapSceneSprites == null) {
							class120.mapSceneSprites = DefaultsGroup.method6754(class299.archive8, class181.spriteIds.mapScenes, 0);
						} else {
							++var0;
						}

						if (BufferedSource.headIconPkSprites == null) {
							BufferedSource.headIconPkSprites = Tiles.method1959(class299.archive8, class181.spriteIds.headIconsPk, 0);
						} else {
							++var0;
						}

						if (MusicPatchNode.headIconPrayerSprites == null) {
							MusicPatchNode.headIconPrayerSprites = Tiles.method1959(class299.archive8, class181.spriteIds.field4370, 0);
						} else {
							++var0;
						}

						if (class229.headIconHintSprites == null) {
							class229.headIconHintSprites = Tiles.method1959(class299.archive8, class181.spriteIds.field4369, 0);
						} else {
							++var0;
						}

						if (class7.mapMarkerSprites == null) {
							class7.mapMarkerSprites = Tiles.method1959(class299.archive8, class181.spriteIds.field4371, 0);
						} else {
							++var0;
						}

						if (Canvas.crossSprites == null) {
							Canvas.crossSprites = Tiles.method1959(class299.archive8, class181.spriteIds.field4373, 0);
						} else {
							++var0;
						}

						if (MusicPatchNode.mapDotSprites == null) {
							MusicPatchNode.mapDotSprites = Tiles.method1959(class299.archive8, class181.spriteIds.field4374, 0);
						} else {
							++var0;
						}

						if (InterfaceParent.scrollBarSprites == null) {
							InterfaceParent.scrollBarSprites = DefaultsGroup.method6754(class299.archive8, class181.spriteIds.field4375, 0);
						} else {
							++var0;
						}

						if (VarpDefinition.modIconSprites == null) {
							VarpDefinition.modIconSprites = DefaultsGroup.method6754(class299.archive8, class181.spriteIds.field4376, 0);
						} else {
							++var0;
						}
						...
						if (var0 < 11) {
							...
							class120.mapSceneSprites[0].shiftColors(var24 + var28, var28 + var38, var25 + var28);
						...
						if (!class201.field2366.isFullyLoaded()) {
							...
							GameBuild.textureProvider = new TextureProvider(class201.field2366, class299.archive8, 20, ClanMate.clientPreferences.method2155(), Client.isLowDetail ? 64 : 128);
							Rasterizer3D.Rasterizer3D_setTextureLoader(GameBuild.textureProvider);
							Rasterizer3D.Rasterizer3D_setBrightness(ClanMate.clientPreferences.method2155());
						...
						if (!KitDefinition.archive10.tryLoadFileByNames("huffman", "")) {
							...
							Huffman var36 = new Huffman(KitDefinition.archive10.takeFileByNames("huffman", ""));
							WorldMapIcon_0.method4776(var36);
					...
					class127.method2733(Renderable.archive2);
					LoginPacket.method5077(Renderable.archive2);
					class152.method3014(Renderable.archive2, FloorUnderlayDefinition.archive11);
					Archive var23 = Renderable.archive2;
					var1 = FloorUnderlayDefinition.archive11;
					boolean var26 = Client.isLowDetail;
					ObjectComposition.ObjectDefinition_archive = var23;
					ObjectComposition.ObjectDefinition_modelsArchive = var1;
					ObjectComposition.ObjectDefinition_isLowDetail = var26;
					FloorDecoration.method3856(Renderable.archive2, FloorUnderlayDefinition.archive11);
					Archive var3 = Renderable.archive2;
					StructComposition.StructDefinition_archive = var3;
					MidiPcmStream.method5249(Renderable.archive2, FloorUnderlayDefinition.archive11, Client.isMembersWorld, class306.fontPlain11);
					class134.method2786(Renderable.archive2, ClanChannelMember.archive5, Decimator.field403);
					Archive var4 = Renderable.archive2;
					Archive var27 = FloorUnderlayDefinition.archive11;
					SpotAnimationDefinition.SpotAnimationDefinition_archive = var4;
					SpotAnimationDefinition.SpotAnimationDefinition_modelArchive = var27;
					Decimator.method994(Renderable.archive2);
					class134.method2792(Renderable.archive2);
					...
					Clock.method3200(Renderable.archive2);
					class131.method2762(Renderable.archive2);
					...
					if (var19.isFullyLoaded()) {
						...
						for (int var21 = 0; var21 < WorldMapElement.WorldMapElement_count; ++var21) {
							...
							if (var22 != null) {
								...
								WorldMapElement.WorldMapElement_cached[var21].method3226();
							}
						}
					}
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (ClanMate.clientPreferences.method2151()) {
									var13 += 15;
										...
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												if (var10.inventorySprites != null && var19 < 20) {
													SpritePixels var45 = var10.getInventorySprite(var19);
													if (var45 != null) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class16.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													...
													if (Client.isItemSelected == 1 && var19 == class67.selectedItemSlot && var10.id == class150.selectedItemWidget) {
														var27 = class83.getItemSprite(var26, var10.itemQuantities[var19], 2, 0, 2, false);
													} else {
														var27 = class83.getItemSprite(var26, var10.itemQuantities[var19], 1, 3153952, 2, false);
													}
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemComposition var46 = AttackOption.ItemDefinition_get(var10.itemId);
												var43 = var46.name;
												if (var43 == null) {
													var43 = "null";
												}
												...
												if ((var46.isStackable == 1 || var10.itemQuantity != 1) && var10.itemQuantity != -1) {
													var43 = Clock.colorStartTag(16748608) + var43 + "</col>" + " " + 'x' + ArchiveLoader.formatItemStacks(var10.itemQuantity);
												}
											}
											...
											if (!var10.isIf3) {
												var43 = Decimator.method1006(var43, var10);
											}
											...
											if (var40 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var40.method7986(var10.width / 2 + var12, var10.height / 2 + var13, var10.spriteAngle, var22);
													} else if (var14 != 0) {
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var40.method7986(var20 / 2 + var12 + var24 * var20, var21 / 2 + var13 + var21 * var25, var10.spriteAngle, 4096);
															} else if (var14 != 0) {
										...
										if (var10.type == 6) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												var34 = AttackOption.ItemDefinition_get(var10.itemId);
												if (var34 != null) {
											...
											Rasterizer3D.method3944(var10.width / 2 + var12, var10.height / 2 + var13);
											var23 = Rasterizer3D.Rasterizer3D_sine[var10.modelAngleX] * var10.modelZoom >> 16;
											var24 = Rasterizer3D.Rasterizer3D_cosine[var10.modelAngleX] * var10.modelZoom >> 16;
											if (var41 != null) {
												if (!var10.isIf3) {
													var41.method4302(0, var10.modelAngleY, 0, var10.modelAngleX, 0, var23, var24);
												} else {
													var41.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														var41.method4230(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY, var10.modelZoom);
													} else {
														var41.method4302(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var34 = AttackOption.ItemDefinition_get(var10.itemIds[var20] - 1);
															String var33;
															if (var34.isStackable != 1 && var10.itemQuantities[var20] == 1) {
																var33 = Clock.colorStartTag(16748608) + var34.name + "</col>";
															} else {
																var33 = Clock.colorStartTag(16748608) + var34.name + "</col>" + " " + 'x' + ArchiveLoader.formatItemStacks(var10.itemQuantities[var20]);
															}
											...
											if (var10.type == 8 && var10 == EnumComposition.field1890 && Client.field640 == Client.field686) {
												...
												for (var32 = Decimator.method1006(var32, var10); var32.length() > 0; var26 = var26 + var31.ascent + 1) {
													...
													var31.draw(var44, var24 + 3, var26, 0, -1);
												}
											}
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													MouseRecorder.method2006(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											}
										}
									}
