	...
	static int method2280(int var0, Script var1, boolean var2) {
		...
		if (var0 == 4000) {
			...
			if (var0 == 4006) {
				...
				var3 = WorldMapManager.method4684(Interpreter.Interpreter_intStack[--User.Interpreter_intStackSize]);
				Interpreter.Interpreter_intStack[++User.Interpreter_intStackSize - 1] = var3;
				return 1;
			} else if (var0 == 4026) {
				User.Interpreter_intStackSize -= 2;
				...
				var4 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++User.Interpreter_intStackSize - 1] = Tile.method3870(var3, var4, var5);
				return 1;
			} else if (var0 == 4028) {
				User.Interpreter_intStackSize -= 3;
				var3 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++User.Interpreter_intStackSize - 1] = NPC.method2269(var3, var4, var5);
				return 1;
			} else if (var0 == 4029) {
				User.Interpreter_intStackSize -= 3;
				var3 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize];
				...
				var5 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 2];
				var6 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 3];
				var3 = NPC.method2269(var3, var5, var6);
				...
				Interpreter.Interpreter_intStack[User.Interpreter_intStackSize - 1] = WorldMapLabelSize.method4393(Interpreter.Interpreter_intStack[User.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4034) {
				User.Interpreter_intStackSize -= 2;
				var3 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[User.Interpreter_intStackSize + 1];
				var5 = class343.method6161(var3, var4);
