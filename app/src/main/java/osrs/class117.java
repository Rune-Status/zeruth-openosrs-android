...
public class class117 {
	...
	int method2620(Buffer var1, int var2) {
		...
		this.field1451 = this.field1441[this.method2647() - 1].field1400;
		this.field1454 = new float[this.method2621() + 1];

		for (var14 = this.method2622(); var14 <= this.method2644(); ++var14) {
			this.field1454[var14 - this.method2622()] = class10.method86(this, (float)var14);
		}

		this.field1441 = null;
		this.field1452 = class10.method86(this, (float)(this.method2622() - 1));
		this.field1443 = class10.method86(this, (float)(this.method2644() + 1));
		return var3;
	}
	...
	public float method2640(int var1) {
		if (var1 < this.method2622()) {
			return this.field1452;
		} else {
			return var1 > this.method2644() ? this.field1443 : this.field1454[var1 - this.method2622()];
		}
	}
	...
	int method2621() {
		return this.method2644() - this.method2622();
	}
	...
	int method2625(float var1) {
		if (this.field1446 < 0 || (float)this.field1441[this.field1446].field1400 > var1 || this.field1441[this.field1446].field1404 != null && (float)this.field1441[this.field1446].field1404.field1400 <= var1) {
			if (var1 >= (float)this.method2622() && var1 <= (float)this.method2644()) {
				int var2 = this.method2647();
	...
	class113 method2626(float var1) {
