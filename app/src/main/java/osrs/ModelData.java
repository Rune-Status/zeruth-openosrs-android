...
public class ModelData extends Renderable {
	...
	static {
		field2269 = new int[10000];
		field2270 = new int[10000];
		field2271 = 0;
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		if (var9) {
			this.field2262 = new int[this.verticesCount][];
			this.field2257 = new int[this.verticesCount][];
		}
		...
		for (var10 = 0; var10 < var2; ++var10) {
			...
			if (var11 != null) {
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) {
					...
					this.indices1[this.faceCount] = this.method3764(var11, var11.indices1[var12]);
					this.indices2[this.faceCount] = this.method3764(var11, var11.indices2[var12]);
					this.indices3[this.faceCount] = this.method3764(var11, var11.indices3[var12]);
					++this.faceCount;
				}
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) {
					...
					if (var13 == 0) {
						this.texTriangleX[this.textureTriangleCount] = (short)this.method3764(var11, var11.texTriangleX[var12]);
						this.texTriangleY[this.textureTriangleCount] = (short)this.method3764(var11, var11.texTriangleY[var12]);
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method3764(var11, var11.texTriangleZ[var12]);
					}
	...
	ModelData(byte[] var1) {
		...
		if (var1[var1.length - 1] == -3 && var1[var1.length - 2] == -1) {
			...
			this.method3762(var1);
		} else {
			this.method3778(var1);
		}
	...
	void method3760(byte[] var1) {
		...
		if (var18 == 1) {
			for (var53 = 0; var53 < var9; ++var53) {
				...
				this.field2262[var53] = new int[var54];
				this.field2257[var53] = new int[var54];

				for (var55 = 0; var55 < var54; ++var55) {
					this.field2262[var53][var55] = var6.readUnsignedByte();
					this.field2257[var53][var55] = var6.readUnsignedByte();
				}
			}
		}
	...
	void method3761(byte[] var1) {
		...
		if (var17 == 1) {
			for (var40 = 0; var40 < var9; ++var40) {
				...
				this.field2262[var40] = new int[var41];
				this.field2257[var40] = new int[var41];

				for (var42 = 0; var42 < var41; ++var42) {
					this.field2262[var40][var42] = var8.readUnsignedByte();
					this.field2257[var40][var42] = var8.readUnsignedByte();
				}
			}
		}
	...
	final int method3764(ModelData var1, int var2) {
		int var3 = -1;
		...
		if (var3 == -1) {
			...
			if (var1.field2262 != null) {
				this.field2262[this.verticesCount] = var1.field2262[var2];
				this.field2257[this.verticesCount] = var1.field2257[var2];
			}
	...
	@ObfuscatedName("a")
	@ObfuscatedSignature(
		descriptor = "([[IIIIZI)Lgp;"
	)
	public ModelData method3767(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		this.calculateBounds();
		int var7 = var2 + this.field2237;
		int var8 = var2 + this.field2231;
		int var9 = var4 + this.field2268;
		int var10 = var4 + this.field2267;
	...
	@ObfuscatedName("r")
	public void method3772(int var1) {
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) {
			super.height = 0;
			this.field2273 = 0;
			this.field2237 = 999999;
			this.field2231 = -999999;
			...
			for (int var1 = 0; var1 < this.verticesCount; ++var1) {
				...
				if (var2 < this.field2237) {
					this.field2237 = var2;
				}

				if (var2 > this.field2231) {
					this.field2231 = var2;
				}
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) {
			...
			var8.field2533 = new int[var8.field2532];
			var8.field2525 = new int[var8.field2532];
			var8.field2517 = new int[var8.field2532];
			var10 = 0;

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) {
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
					var8.field2533[var10] = this.texTriangleX[var11] & '\uffff';
					var8.field2525[var10] = this.texTriangleY[var11] & '\uffff';
					var8.field2517[var10] = this.texTriangleZ[var11] & '\uffff';
					var9[var11] = var10++;
				} else {
					var9[var11] = -1;
				}
			...
			var8.field2529 = new byte[this.faceCount];

			for (var11 = 0; var11 < this.faceCount; ++var11) {
				if (this.textureCoords[var11] != -1) {
					var8.field2529[var11] = (byte)var9[this.textureCoords[var11] & 255];
				} else {
					var8.field2529[var11] = -1;
				}
			}
		}
			...
			if (var12 == -1) {
				if (var17 != 0) {
					if (var17 == 1) {
						...
						var8.faceColors1[var16] = method3804(this.faceColors[var16] & '\uffff', var14);
					...
					var8.faceColors1[var16] = method3804(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors2[var16] = method3804(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors3[var16] = method3804(var15, var14);
				}
			} else if (var17 != 0) {
				if (var17 == 1) {
					var19 = this.faceNormals[var16];
					var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7) + var1;
					var8.faceColors1[var16] = method3784(var14);
					var8.faceColors3[var16] = -1;
				} else {
					var8.faceColors3[var16] = -2;
				}
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors2[var16] = method3784(var14);
				if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) {
					var13 = this.vertexVertices[this.indices3[var16]];
				} else {
					var13 = this.vertexNormals[this.indices3[var16]];
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors3[var16] = method3784(var14);
			}
		}
	...
	@ObfuscatedName("g")
	@ObfuscatedSignature(
		descriptor = "(Lgp;Lgp;IIIZ)V"
	)
	static void method3781(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) {
			...
			if (var10.magnitude != 0) {
				...
				if (var11 <= var1.field2273) {
					...
					if (var12 >= var1.field2237 && var12 <= var1.field2231) {
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.faceCount; ++var9) {
				if (field2269[var0.indices1[var9]] == field2271 && field2269[var0.indices2[var9]] == field2271 && field2269[var0.indices3[var9]] == field2271) {
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) {
				if (field2271 == field2270[var1.indices1[var9]] && field2271 == field2270[var1.indices2[var9]] && field2271 == field2270[var1.indices3[var9]]) {
	...
	@ObfuscatedName("aq")
	static final int method3804(int var0, int var1) {
	...
	@ObfuscatedName("av")
	static final int method3784(int var0) {
		if (var0 < 2) {
			var0 = 2;
		} else if (var0 > 126) {
			var0 = 126;
