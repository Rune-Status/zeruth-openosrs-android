...
public class WorldMapEvent {
	...
	public static void method4997() {
		try {
			if (class273.musicPlayerStatus == 1) {
				int var0 = ItemContainer.midiPcmStream.method5170();
	...
	static void method4996(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != ScriptFrame.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					...
					var8.packetBuffer.method7560(0);
					var8.packetBuffer.method7540(var3[var6]);
					...
					var8.packetBuffer.method7771(0);
					var8.packetBuffer.method7540(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 7) {
