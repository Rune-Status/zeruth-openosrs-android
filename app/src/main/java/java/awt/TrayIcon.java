...
public class TrayIcon {
    ...
    transient EventListenerList list = new EventListenerList();
    private Image image;
     ...
     * @throws HeadlessException             if {@code GraphicsEnvironment.isHeadless()} returns
     *                                       {@code true}
     ...
     *
     * @param popup a <code>PopupMenu</code> or <code>null</code> to remove any
     *              popup menu
     * @throws IllegalArgumentException if the {@code popup} is already set for another
     *                                  {@code TrayIcon}
     * @see #getPopupMenu
     */
     ...
     *
     * @param tooltip the string for the tooltip; if the value is <code>null</code>
     *                no tooltip is shown
     * @see #getToolTip
     */
     ...
     *
     * @param autosize <code>true</code> to auto-size the image, <code>false</code>
     *                 otherwise
     * @see #isImageAutoSize
     */
     ...
     *
     * @param caption     the caption displayed above the text, usually in bold; may be
     *                    <code>null</code>
