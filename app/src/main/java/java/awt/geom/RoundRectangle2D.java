...
public abstract class RoundRectangle2D extends RectangularShape {
     ...
     * values.
     *
     * @param x         the X coordinate to which to set the location of this
     *                  <code>RoundRectangle2D</code>
     * @param y         the Y coordinate to which to set the location of this
     *                  <code>RoundRectangle2D</code>
    ...
    public static class Float extends RoundRectangle2D implements Serializable {
         ...
         *             <code>RoundRectangle2D</code>
         * @param w    the width to which to set the newly constructed
         *             <code>RoundRectangle2D</code>
         * @param h    the height to which to set the newly constructed
         *             <code>RoundRectangle2D</code>
         * @param arcw the width of the arc to use to round off the corners of
         *             the newly constructed <code>RoundRectangle2D</code>
         * @param arch the height of the arc to use to round off the corners of
         *             the newly constructed <code>RoundRectangle2D</code>
         * @since 1.2
         */
