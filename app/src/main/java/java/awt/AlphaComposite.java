 ...
 * (1-<em>A<sub>s</sub></em>). Once a set of equations for determining the
 * blending factors is known they can then be applied to each pixel to produce a
 * result using the following set of equations:
 *
 * <pre>
 ...
 *
 * <p>
 * For performance reasons, it is preferrable that <code>Raster</code> objects
...
public final class AlphaComposite implements Composite {
     ...
     * Destination rule).
     * <p>
     * <em>F<sub>s</sub></em> = 1 and <em>F<sub>d</sub></em> =
     ...
     * @throws IllegalArgumentException if <code>rule</code> is not one of the following:
