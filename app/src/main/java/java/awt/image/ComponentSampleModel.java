...
public class ComponentSampleModel extends SampleModel {
     ...
     * @throws IllegalArgumentException if the product of <code>w</code> and <code>h</code> is
     ...
     * @throws IllegalArgumentException if any of the bank indices of <code>bandIndices</code> is
     *                                  less than 0
     * @throws IllegalArgumentException if <code>dataType</code> is not one of the supported data
     *                                  types
     */
    ...
    public SampleModel createSubsetSampleModel(int[] bands) {
        if (bands.length > bankIndices.length)
            throw new Error("There are only " + bankIndices.length + " bands");// RasterFormat
     ...
     * @throws ArrayIndexOutOfBoundsException if the coordinates are not in bounds, or if obj is too small
     *                                        to hold the output.
     ...
     * @throws NullPointerException           if data is null.
     * @throws ArrayIndexOutOfBoundsException if the coordinates are not in bounds, or if iArray is too
