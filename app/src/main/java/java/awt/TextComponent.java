...
public class TextComponent extends Component implements Accessible {
     ...
     *
     * @param text the text to be displayed; if <code>text</code> is
     ...
     * specified text.
     *
     * @param t the new text; if this parameter is <code>null</code> then the
     ...
     *
     * @param b a flag indicating whether this text component is user
     *          editable.
     ...
     *
     * @param c The color to become this text component's color. If this
     ...
     *
     * @param selectionStart the zero-based index of the first character (<code>char</code>
     *                       value) to be selected
     * @param selectionEnd   the zero-based end position of the text to be selected; the
     ...
     *
     * @param listenerType the type of listeners requested; this parameter should specify
     ...
     * @throws ClassCastException if <code>listenerType</code> doesn't specify a class or
